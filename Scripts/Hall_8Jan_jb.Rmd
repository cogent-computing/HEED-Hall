---
title: "Hall data analysis (Aug-Oct 2019)"
output:
...
```
This report contains analysis of data obtained from the standalone solar system installed at Nyabiheke Hall for period between 1st Aug 2019 and 31st Oct 2019. There are a total of 7 CPE (6 indoor and 1 outdoor) and 4 sockets.
...
pc_sum_wday[pc_sum_wday$month=="Aug",] %>%
  ...
  labs(title="Total power consumption of microgrid on a weekday in Aug'19" , 
       ...
       x = "Hour of day")
```
`r fig_cap(1, caption = "Total power consumption of microgrid on a week day in Aug 2019")`
...
pc_sum_weday[pc_sum_weday$month=="Aug",] %>%
  ...
  labs(title="Total power consumption of microgrid on a weekend day in Aug'19" ,
       ...
       x = "Hour of day")
```
`r fig_cap(2, caption = "Total power consumption of microgrid on a weekend day in Aug 2019")`
...
pc_sum_wday[pc_sum_wday$month=="Sep",] %>%
  ...
  labs(title="Total power consumption of microgrid on a weekday in Sep'19" , 
       ...
       x = "Hour of day")
```
`r fig_cap(3, caption = "Total power consumption of microgrid on a week day in Sep 2019")`
...
pc_sum_weday[pc_sum_weday$month=="Sep",] %>%
  ...
  labs(title="Total power consumption of microgrid on a weekend day in Sep'19" ,
       ...
       x = "Hour of day")
```
`r fig_cap(4, caption = "Total power consumption of microgrid on a weekend day in Sep 2019")`
...
```
`r fig_cap(5, caption = "Total power consumption of microgrid on a week day in Oct 2019")`
...
pc_sum_weday[pc_sum_weday$month=="Oct",] %>%
  ...
  labs(title="Total power consumption of microgrid on a weekend day in Oct'19" , 
       ...
       x = "Hour of day")
```
`r fig_cap(6, caption = "Total power consumption of microgrid on a weekend day in Oct 2019")`
...
pc_sum_wday[pc_sum_wday$month=="Aug",] %>%
  ...
  labs(title="Power consumption of sockets on a week day in Aug 2019" , 
       ...
       x = "Hour of day")
```
`r fig_cap(7, caption = "Power consumption of sockets on a week day in Aug 2019")`
...
pc_sum_weday[pc_sum_weday$month=="Aug",] %>%
  ...
  labs(title="Power consumption of sockets on a weekend day in Aug 2019" , 
       ...
       x = "Hour of day")
```
`r fig_cap(8, caption = "Power consumption of sockets on a weekend day in Aug 2019")`
...
```
`r fig_cap(9, caption = "Power consumption of sockets on a week day in Sep 2019")`
...
pc_sum_weday[pc_sum_weday$month=="Sep",] %>%
  ...
  labs(title="Power consumption of sockets on a weekend day in Sep 2019" , 
       ...
       x = "Hour of day")
```
`r fig_cap(10, caption = "Power consumption of sockets on a weekend day in Sep 2019")`
...
pc_sum_wday[pc_sum_wday$month=="Oct",] %>%
  ...
  labs(title="Power consumption of sockets on a week day in Oct 2019" , 
       ...
       x = "Hour of day")
```
`r fig_cap(11, caption = "Power consumption of sockets on a week day in Oct 2019")`
...
pc_sum_weday[pc_sum_weday$month=="Oct",] %>%
  ...
  labs(title="Power consumption of sockets on a weekend day in Oct 2019" , 
       ...
       x = "Hour of day")
```
`r fig_cap(12, caption = "Power consumption of sockets on a weekend day in Oct 2019")`
...
pc_sum_wday[pc_sum_wday$month=="Aug",] %>%
  ...
  labs(title="Power consumption of indoor lights on a week day in Aug 2019" , 
       ...
       x = "Hour of day")
```
`r fig_cap(13, caption = "Power consumption of indoor lights on a week day in Aug 2019")`
...
pc_sum_weday[pc_sum_weday$month=="Aug",] %>%
  ...
  labs(title="Power consumption of indoor lights on a weekend day in Aug 2019" , 
       ...
       x = "Hour of day")
```
`r fig_cap(14, caption = "Power consumption of indoor lights on a weekend day in Aug 2019")`
...
pc_sum_wday[pc_sum_wday$month=="Sep",] %>%
  ...
  labs(title="Power consumption of indoor lights on a weekday in Sep 2019" , 
       ...
       x = "Hour of day")
```
`r fig_cap(15, caption = "Power consumption of indoor lights on a week day in Sep 2019")`
...
pc_sum_weday[pc_sum_weday$month=="Sep",] %>%
  ...
  labs(title="Power consumption of indoor lights on a weekend day in Sep 2019" , 
       ...
       x = "Hour of day")
```
`r fig_cap(16, caption = "Power consumption of indoor lights on a weekend day in Sep 2019")`
...
pc_sum_wday[pc_sum_wday$month=="Oct",] %>%
  ...
  labs(title="Power consumption of indoor lights on a weekday in Oct 2019" , 
       ...
       x = "Hour of day")
```
`r fig_cap(17, caption = "Power consumption of indoor lights on a week day in Oct 2019")`
...
pc_sum_weday[pc_sum_weday$month=="Oct",] %>%
  ...
  labs(title="Power consumption of indoor lights on a weekend day in Oct 2019" , 
       ...
       x = "Hour of day")
```
`r fig_cap(18, caption = "Power consumption of indoor lights on a weekend day in Oct 2019")`
...
pc_sum_wday[pc_sum_wday$month=="Aug",] %>%
  ...
  labs(title="Power consumption of outdoor lights on a week day in Aug 2019" , 
       ...
       x = "Hour of day")
```
`r fig_cap(19, caption = "Power consumption of outdoor lights on a week day in Aug 2019")`
...
pc_sum_weday[pc_sum_weday$month=="Aug",] %>%
  ...
  labs(title="Power consumption of outdoor lights on a weekend day in Aug 2019" ,
       ...
       x = "Hour of day")
```
`r fig_cap(20, caption = "Power consumption of outdoor lights on a weekend day in Aug 2019")`
...
pc_sum_wday[pc_sum_wday$month=="Sep",] %>%
  ...
  labs(title="Power consumption of outdoor lights on a week day in Sep 2019" , 
       ...
       x = "Hour of day")
```
`r fig_cap(21, caption = "Power consumption of outdoor lights on a week day in Sep 2019")`
...
pc_sum_weday[pc_sum_weday$month=="Sep",] %>%
  ...
  labs(title="Power consumption of outdoor lights on a weekend day in Sep 2019",
       ...
       x = "Hour of day")
```
`r fig_cap(22, caption = "Power consumption of outdoor lights on a weekend day in Sep 2019")`
...
pc_sum_wday[pc_sum_wday$month=="Oct",] %>%
  ...
  labs(title="Power consumption of outdoor lights on a week day in Oct 2019", 
       ...
       x = "Hour of day")
```
`r fig_cap(23, caption = "Power consumption of outdoor lights on a week day in Oct 2019")`
...
pc_sum_weday[pc_sum_weday$month=="Oct",] %>%
  ...
  labs(title="Power consumption of outdoor lights on a weekend day in Oct 2019",
       ...
       x = "Hour of day")
```
`r fig_cap(24, caption = "Power consumption of outdoor lights on a weekend day in Oct 2019")`


RQ2. Does energy availability through a PV system increase energy demand
over time? 

To see how total energy consumption changes over time, daily consumption since the commissioning of the hall installation is plotted. Using this plot, we will be able to see if there has been a growth in energy usage at the hall and how much it has changed over time. Additional plots are  created to show the individual socket and light make-up of the energy usage on a daily and monthly basis.  By creating monthly plots for the individual sockets and lights we will be able to determine where any changes in energy usage are occurring.

1. Daily total energy consumption of Hall per month and total energy consumption since commissioning. The monthly daily consumption average is also shown.
...
```
`r fig_cap(25, caption = "Daily total energy consumption (lights + sockets) in Aug 2019")`
...
energy_total[energy_total$month=="Sep",] %>%
  ...
  theme(axis.text.x = element_text(size=6, angle=45))
```
`r fig_cap(26, caption = "Daily total energy consumption (lights + sockets) in Sep 2019")`
...
energy_total[energy_total$month=="Oct",] %>%
  ...
  theme(axis.text.x = element_text(size=6, angle=45))
```
`r fig_cap(27, caption = "Daily total energy consumption (lights + sockets) in Oct 2019")`
...
energy_total %>%
  ...
  labs(title="Total energy consumption since commissioning " , 
       ...
       colour="") 
```
`r fig_cap(28, caption = "Daily consumption (lights + sockets) since commissioning")`
...
energy_month %>%
  ...
  labs(title="Average total daily energy consumption" , 
       ...
       fill="") 
```
`r fig_cap(29, caption = "Monthly daily consumption average at Nyabiheke Hall in 2019")`


2. Daily total user consumption loads for the hall in (month).

```{r, echo=FALSE}
#Daily indoor lights consumption - extract all CPE from cpe_daily except cpe5
cpe_daily_in <- cpe_daily[cpe_daily$id!="CPE5", ] #Wh
#Combine daily consumption of all cpe
cpe_daily_indoor <- cpe_daily_in %>%
  group_by(date) %>%
  summarise(value=sum(value))
cpe_daily_indoor$location <- rep("Indoor lights", length(cpe_daily_indoor$date))

#Daily outdoor lights consumption - extract only cpe5 from cpe_daily
cpe_daily_outdoor <- cpe_daily[cpe_daily$id=="CPE5", ] #Wh
cpe_daily_outdoor$location <- rep("Outoor lights", length(cpe_daily_outdoor$date))
cpe_daily_outdoor <- cpe_daily_outdoor[,-2]

#Daily sockets consumption - use s_hours as is
s_daily <- s_hours #Wh
...
```{r, echo=FALSE}
#Extract AC consumption from systemData to calculate auxiliary loads
ac_consumption <- systemData[,c(1,2)]
colnames(ac_consumption) <- c("timestamp", "AC_consumption_L1_W")

#Extract data from Aug to Oct and remove NA values
...
#Daily ac consumption - sum of values for all 24 hours (Wh)
ac_days <- ac_hours %>%
  group_by(date) %>%
  summarise(value=sum(value))
...
```{r, echo=FALSE}
#Calculating auxiliary load as AC consumption - s_daily - cpe_daily_indoor - cpe_daily_outdoor
...
daily_profile_gather[daily_profile_gather$month=="Aug", ] %>%
  ...
  theme(axis.text.x = element_text(size=6, angle=45))
```
`r fig_cap(30, caption = "Daily user and system energy consumption in Aug 2019")`
...
daily_profile_gather[daily_profile_gather$month=="Sep", ] %>%
  ...
  theme(axis.text.x = element_text(size=6, angle=45))
```
`r fig_cap(31, caption = "Daily user and system energy consumption in Sep 2019")`
...
daily_profile_gather[daily_profile_gather$month=="Oct", ] %>%
  ...
  theme(axis.text.x = element_text(size=6, angle=45))
```
`r fig_cap(32, caption = "Daily user and system energy consumption in Oct 2019")`


3. Monthly energy consumption profile for the hall users.
```{r, echo=FALSE, fig.width= 5, fig.height=5}
#Monthly energy consumption profile for the micro-grid users.
library(lubridate)
...
monthly_profile %>%
  ggplot(aes(x = month, y= value/1000.0, fill = key)) +
  geom_bar(stat="identity", width=.5, position = "stack") + 
  labs(title="Total monthly energy consumption values at Hall in 2019" , 
       y="Total monthly energy consumption (kWh)",
       x = "Month of study") 
```
`r fig_cap(33, caption = "Total monthly energy consumption at Nyabiheke hall.")`
...
To better understand any under and over usage predictions, the distribution of errors in terms of watthours is to be plotted. Determining the occurrence of under and over predictions at the hall enables designers to evaluate the impact of increasing or decreasing system capacity. For example, if a designer was to reduce system capacity due to surplus solar energy going to waste, the number of occurrences of under predictions would give an indication of likely capacity shortages. The plot will show us the skew towards under or over predictions and the scale of the errors. 

To investigate when these differences in energy usage are occurring, an actual and predicted typical day at the hall for each month is to be created.  A typical day, for a given month, for the generation and load profiles at the hall enables us to see how total system consumption varies throughout the day and when energy is delivery by the PV panels or consumed from the battery. These graphs also show when the battery is being charged and when surplus yield from the PV panels results in capture losses. Differences with predicted values provide an indication of the appropriateness of the assumed load profiles for the hall; these assumed load profiles will also be evaluated in comparison to the results obtained in relation to plots in RQ1. 

The appropriateness of the design in terms capture losses in comparison to simulated values will also be evaluated. By creating graphs for an entire year
for capture losses, we will see how the surplus potential energy from PV panels going to waste changes over time because of variations in energy consumption.
...
data_spread[data_spread$Month=="Aug", ] %>%
  ...
  labs(title="Actual Hall power profile for a typical day in Aug 2019" , 
       ...
       colour="Paramter")
```
`r fig_cap(34, caption = "Actual Hall power profile for a typical day in Aug 2019. Battery state of charge is shown on the secondary axis.")`
...
data_spread[data_spread$Month=="Sep", ] %>%
  ...
  labs(title="Actual Hall power profile for a typical day in Sep 2019" , 
       ...
       colour="Paramter")
```
`r fig_cap(35, caption = "Actual Hall power profile for a typical day in Sep 2019. Battery state of charge is shown on the secondary axis.")`
...
```
`r fig_cap(36, caption = "Actual Hall power profile for a typical day in Oct 2019. Battery state of charge is shown on the secondary axis.")`
...
#Summing value for 24 hours to convert to kWh
...
loss_days %>%
  ...
  labs(title="Excess Electrical Production Monthly Averages in 2019" , 
       ...
       x = "Month")
```
`r fig_cap(37, caption = "Monthly capture losses for the hall.")`



To investigate further the potential PV power that is not utilised at the hall, the estimated monthly capture losses are shown in comparison to the utilised PV power. The ratio of utilised PV power to potential PV power is known as
the performance ratio, and we will want to see how this changes with energy demands at the hall. The production factor is particularly important for standalone PV-battery systems, where surplus energy from PV panels cannot be exported to a grid network. The production factor is the ratio of actual PV yield to potential PV power. The system’s overall efficiency is the ratio of the consumed AD load to the in-plane irradiance on the PV array.

1. Monthly utilised PV yield, PV capture losses and system losses
...
```
`r fig_cap(38, caption = "Monthly utilised PV yield, PV capture losses and system losses.")`


2. System performance ratio, production factor and overall system efficiency
for each month
```{r, echo=FALSE, include = FALSE}
